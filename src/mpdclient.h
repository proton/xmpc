...
const gchar *           xfmpc_mpdclient_get_file                (XfmpcMpdclient *mpdclient);
...
gboolean                xfmpc_mpdclient_playlist_has_filename   (XfmpcMpdclient *mpdclient,
																																 ...
																																 gboolean is_dir);
void                    xfmpc_mpdclient_playlist_end            (XfmpcMpdclient *mpdclient);
...
gboolean                xfmpc_mpdclient_database_playlist_read  (XfmpcMpdclient *mpdclient,
																																 gchar **name);
void                    xfmpc_mpdclient_database_playlist_create(XfmpcMpdclient *mpdclient,
																																 const gchar *name);
void                    xfmpc_mpdclient_database_playlist_rename(XfmpcMpdclient *mpdclient,
																																 const gchar *old_name,
																																 const gchar *name);
void                    xfmpc_mpdclient_database_playlist_remove(XfmpcMpdclient *mpdclient,
																																 const gchar *name);
void                    xfmpc_mpdclient_database_playlist_append(XfmpcMpdclient *mpdclient,
																																 const gchar *playlist,
																																 const gchar *filename);

XfmpcSongInfo *         xfmpc_mpdclient_get_song_info           (XfmpcMpdclient *mpdclient,
																																 gint id);
XfmpcSongInfo *         xfmpc_mpdclient_get_current_song_info   (XfmpcMpdclient *mpdclient);

gboolean				xfmpc_mpdclient_database_playlist_read_contents (XfmpcMpdclient *mpdclient,
															const gchar *playlist,
															gchar **filename);
