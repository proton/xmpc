...
struct XfmpcStreamInfo
{
	gchar* name;
	gchar* url;
};

guint                  xfmpc_preferences_get_streams          (XfmpcPreferences *preferences, struct XfmpcStreamInfo **streamlist);
void                   xfmpc_preferences_add_stream           (XfmpcPreferences *preferences, const gchar* name, const gchar* url);
void                   xfmpc_preferences_edit_stream          (XfmpcPreferences *preferences, guint id, const gchar* name, const gchar* url);
void                   xfmpc_preferences_delete_stream        (XfmpcPreferences *preferences, guint id);

void                   xfmpc_preferences_stream_get           (XfmpcPreferences *preferences, guint id, gchar** name, gchar** url);
